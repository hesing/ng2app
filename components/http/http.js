...
var HttpSample = (function () {
    ...
    HttpSample.prototype.loadFriendsSuccessFully = function () {
        var _this = this;
        this.result = { friends: [] };
        this.http.get('./components/http/data/friends.json').map(function (res) { return res.json(); }).subscribe(function (res) { return _this.result = res; });
    };
    HttpSample.prototype.loadContractByCustomer = function () {
        var _this = this;
        this.contract = {};
        this.customer = {};
        this.http.get('./components/http/data/customer.json').map(function (res) {
    ...
    HttpSample.prototype.postData = function () {
        ...
        this.http.post('http://www.syntaxsuccess.com/poc-post/', JSON.stringify({ firstName: 'Hemant', lastName: 'Singh' }), { headers: headers })
