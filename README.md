...
Angular 2 app updated with angular2 `2.0.0-rc.1`

- integration with sass, sass-lint
- Custom theme using bootstrap 4
- sidebar to adjust unlimited menu items
- copy assests (fonts) to build
- production ready
